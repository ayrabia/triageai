      ...
      <header className="sticky top-0 z-40 bg-surface/90 backdrop-blur-md shadow-header">
        <div className="mx-auto max-w-4xl px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-bold tracking-tight text-primary">My Queue</h1>
          </div>
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 rounded px-2.5 py-1 text-xs font-bold tracking-wide uppercase bg-primary-fixed/30 text-primary">
      ...
      <main className="mx-auto max-w-4xl px-6 py-8">
        {fetchError ? (
          ...
          <div className="py-24 flex flex-col items-center">
            ...
            <p className="text-sm font-semibold text-on-surface">No referrals assigned to you.</p>
            <p className="mt-1 text-xs text-on-surface-variant">Your queue is empty.</p>
          </div>
        ) : (
